...
import br.com.eduard.mine_toolkit.command.Command
...
open class EduardPlugin : JavaPlugin(), BukkitTimeHandler, IPluginInstance<JavaPlugin> {
    ...
    fun unregisterMenus() {
        for (menu in Menu.Companion.registeredMenus.toList()) {
            if (this == menu.plugin) {
                menu.unregisterMenu()
            }
        }
    ...
    fun unregisterCommands() {
        CommandManager.Companion.unregisterCommands(this)
        Command.Companion.unregisterCommands(this)
    }
