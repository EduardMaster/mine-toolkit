...
import br.com.eduard.mine_toolkit.kotlin.reloadListFromFolder
import br.com.eduard.mine_toolkit.kotlin.saveListIn
...
open class Minigame(
    ...
    fun saveMaps() {
        File(plugin.dataFolder, "maps/").saveListInFolder(maps) {
            it.name.lowercase(getDefault()).replace(" ", "_") }
    }
